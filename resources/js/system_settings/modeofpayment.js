$(document).ready(function (){
    ...
    $('#store_data').on('submit', function(e){
        e.preventDefault();
        let url = (usertype == "admin") ? "/admin/modeofpayment/" : "/secretary/modeofpayment/";
    ...
    $(document).on('click', '.edit', function(e){
        e.preventDefault();
        let id = $(this).val();
        let url = (usertype == "admin") ? "/admin/modeofpayment/" + id + "/edit" : "/secretary/modeofpayment/" + id + "/edit";
        $('#edit').modal('show');
        $.ajax({
            type: "GET",
            url: url,  
    ...
    $('#update_data').on('submit', function(e){
        e.preventDefault();
        let id = $('#mop_id').val();
        let url = (usertype == "admin") ?  "/admin/modeofpayment/update/"+ id :  "/secretary/modeofpayment/update/"+ id;
        let formData = new FormData(this);
        $.ajaxSetup({
            headers: {
                'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
    ...
    $(document).on('click', '.delete_mop', function(e){
        ...
        let url = (usertype == "admin") ?  "/admin/modeofpayment/"+ id :  "/secretary/modeofpayment/"+ id;
        $.ajaxSetup({
            headers: {
                'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
            }
