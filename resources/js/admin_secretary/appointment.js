    ...
    $(document).ready(function (){
        ...
        let url_pendings = (usertype === 'admin') ? '/admin/appointment' : '/secretary/appointment';
        let url_completes = (usertype === 'admin') ? '/admin/complete-appointment' : '/secretary/complete-appointment';
        let url_cancels = (usertype === 'admin') ? '/admin/cancelled-appointment' : '/secretary/cancelled-appointment';
        let url_transactions = (usertype === 'admin') ? '/admin/transaction-appointment' : '/secretary/transaction-appointment';
        ...
        let pendings = $('#pendings').DataTable({
            processing: true,
            serverSide: true,
            ajax: url_pendings,
            dom: 'frtp',
        ...
        let complete = $('#complete').DataTable({
            processing: true,
            serverSide: true,
            ajax: url_completes,
            dom: 'frtp',
        ...
        var calendar = $('#calendar').fullCalendar({
            ...
            select:function(start, end, allDay) {
                ...
                if(formattedDate == start){
                    ...
                    let url = (usertype === 'admin') ? "/admin/appointment/Calendar-fetch" : "/secretary/appointment/Calendar-fetch";
                                ...
                                if(date_off.includes(start)){
                                    ...
                                    if (selected_date < currentDate) {
                                        ...
                                        if(response.status == "405"){
                                            ...
                                            $('#resched_date').val(formattedDate);
