...
<div class="bgpic" >
    ...
    <div class="textpage1">
            ...
            <div class="btnloginregister" >
                ...
                <a hidden href="/patient/appointment/" class="btnlogin" >Book now</a> 
                @else
                <a href="/patient/appointment/" class="btnlogin" >Book now</a> 
                @endif
            </div>
    ...
    <div class="servicescontainer">
      ...
      <div >
        <p class="undertxt">For more information, contact us at the provided  contact details at the bottom. <br> For interested clients, book an appointment <a style="color:white;text-decoration:none; font-family:'Poppins'; font-weight:900;" href="https://www.jgmarquez-rpsy.com/public/patient/appointment"> here.</a> </p>
      </div>
        ...
        <div style="margin-top:1%; margin-left:2%; margin-right:2%;">
            <div class="row " >
                ...
                @endif
                    ...
                    <a class="aboutreadmore" href="/patient/about_us"> Read More >> </a>
                </div>
