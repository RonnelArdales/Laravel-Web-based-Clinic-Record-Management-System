      ...
      <div class="d-flex justify-content-center">
            <div class="card w-100">
                  <div class="card-body  text-center  " style="background:#EDDBC0; padding: 20px 30px ; border-radius: 5px;box-shadow:  4px 4px 2px rgba(0, 0, 0, 0.25)">
                        ...
                        <form style="margin-top:15px" action="/admin/myprofile/picture/update" method="POST" enctype="multipart/form-data">
                        @else
                        <form style="margin-top:15px" action="/secretary/myprofile/picture/update" method="POST" enctype="multipart/form-data">
                        @endif
