...
<div class="row m-4" style="font-family: Poppins;">
    ...
    <div class="container">
        <div class="row " >
            <div class="col-sm " style=" border-left:12px solid white; height: 135px; border-radius: 10px; background-color:#829460;" >
            ...
            <div class="col-sm " style="margin-left: 15px; margin-right:15px; border-radius: 10px;background: #829460; border-left:12px solid white; height: 135px;" >
                <div class="p-1" style="color: aliceblue">
                    Total
