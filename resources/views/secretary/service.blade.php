...
<script>
    $(document).ready(function (){
        ...
        $(document).on('click', '.add_service', function(e){
            ...
            var data ={
                'servicename' : $('.servicename').val(),//naka set by class
                'price': $('.price').val(), 
            }
            // console.log(data);
            ...
            $.ajax({
                type: "POST",
                url: "/secretary/service/createservice/store",
                data: data,
                datatype: "json",
            ...
            //show data in edit form
             //pag niclick yung button na may class name na edit
           ...
           $('#edit').modal('show');
           $.ajax({
                type: "GET", //get sine kukunin yung data      
                url: "/secretary/service/edit/"+ sercode,  //url kukubnin yung id
                datatype: "json",
                success: function(response){ //return galings sa function sa controller
           ...
           $.ajax({
                type: 'POST', 
                url: "/secretary/service/update/"+sercode,
                data: data,
                datatype: "json",
                success: function(response){ 
                    console.log(response);
        ...
        $(document).on('click', '.delete_service', function(e){
           ...
           $.ajax({
                type: 'DELETE', 
                url: "/secretary/service/delete/"+ sercode,
                data: sercode,
                datatype: "json",
                success: function(response){ 
