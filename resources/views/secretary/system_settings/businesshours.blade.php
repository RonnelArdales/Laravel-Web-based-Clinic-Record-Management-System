...
<script>
    ...
    //     }
        ...
        $('.add_businesshours').on('click', function(e){
            ...
            $.ajax({
                type: "POST",
                url: "/secretary/business_hours/store",
            ...
            $.ajax({
                type: "POST",
                url: "/secretary/business_hours/delete",
                data: {day_id : day_id},
                datatype: "json",
                beforeSend: function(){
                    $(".main-spinner").show();
            ...
            $.ajax({
                url: "/secretary/business_hours/get_hours",
              ...
              headers: {
                ...
                if($('.checked_off').is(":checked")){
                    ...
                    var status = "checked"
                        $.ajax({
                            type: "PUT",
                            url: "/secretary/business_hours/off_status",
                            data: {day_id : day_id,
                                    status: status,
                                                        },
                            datatype: "json",
          ...
          $.ajax({
                            type: "POST",
                            url: "/secretary/business_hours/store_date",
                            data: {date : $('.date').val() },
                            datatype: "json",
                            beforeSend: function(){
                    $(".main-spinner").show();
        ...
        $(document).on('click', '.delete_date'  ,function(e){
            ...
            $.ajax({
                type: "DELETE",
                url: "/secretary/business_hours/date/delete",
