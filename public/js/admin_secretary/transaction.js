...
$(document).ready(function () {
  ...
  // ------ get max biling no --------------//
  function get_maxid() {
    var url = usertype == "admin" ? "/admin/transaction/getid" : "/secretary/transaction/getid";
    $.ajaxSetup({
      headers: {
  ...
  $(document).on('change', '.getservice', function (e) {
    e.preventDefault();
    var id = $(this).val();
    var url = usertype == "admin" ? "/admin/transaction/getservice/" + id : "/secretary/transaction/getservice/" + id;
    $.ajaxSetup({
      headers: {
        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
      }
  ...
  $(document).on('click', '.store_addtocart', function (e) {
    e.preventDefault();
    var url = usertype == "admin" ? "/admin/transaction/addtocart/store" : "/secretary/transaction/addtocart/store";
    var data = {
      'transno': $('#getid').val(),
      'user_id': $('#userid').val(),
  ...
  $(document).on('click', '.saveaddtocart', function (e) {
    e.preventDefault();
    var url = usertype == "admin" ? "/admin/transaction/addtocart/billing_store" : "/secretary/transaction/addtocart/billing_store";
    $.ajaxSetup({
      headers: {
        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
      }
  ...
  $(document).on('click', '.delete', function (e) {
    e.preventDefault();
    var id = $(this).val();
    var url = usertype == "admin" ? "/admin/transaction/" + id : "/secretary/transaction/" + id;
